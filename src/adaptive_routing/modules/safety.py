...
## Team 404FoundUs
## @file src/adaptive_routing/modules/safety.py
...
class SafetyAuditModule:
    ...
    def _run_audit_(self, normalized_query, response_text, route, history=None, system_instructions=None, strictness_override=None):
        """
        @func_ _run_audit_
        ...
        @params system_instructions : (str, optional) Dynamic override for safety audit system instructions.
        @params strictness_override : (float, optional) Dynamic override for the route's strictness threshold.
        ...
        if route == "Casual-LLM":
            ...
            strictness = strictness_override if strictness_override is not None else FrameworkConfig._VERIFICATION_STRICTNESS_CASUAL
            return {
